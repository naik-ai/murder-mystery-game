...
**WARNING: HOST ONLY — DO NOT SHOW TO PLAYERS**

This document contains the complete solution.

---

## PHASE 4: FINAL RECONSTRUCTION

**Duration: 15 Minutes**

### Host Instructions

1. Distribute the **Summary Cards** (below) to each detective
2. Give players the **Final Answer Card**
3. Set 15-minute timer
4. Players must agree unanimously on all five answers
5. Collect answers, then read the **Solution** aloud
...
- Dim lighting
- Jazz or noir background music (low volume)
- Whiskey or mocktails (on theme)
- Indian dinner to match setting
