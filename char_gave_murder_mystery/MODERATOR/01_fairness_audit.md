...
| Madhav named explicitly | Interview 12 (Phase 1) | ✅ FIXED - No longer named |
...
Players can solve T1 conspiracy by end of Phase 1:
- T1: Vasti villagers place Vasundhara at scene + Raghoba's guilt

T2-T3 now requires Phase 2 (after Interview 12 fix):
- T2-T3: Aarav's testimony + industrial smell + truck pattern

### Required Fix

1. ✅ Remove/obscure T2-T3 killer identity from Phase 1 (Interview 12 fixed)
2. Still needed: obscure T1 killer identity from Phase 1
