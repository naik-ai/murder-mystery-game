...
1. **Stage 1 — Bottle Swap:** Original gift bottle swapped with pre-drugged duplicate
2. **Stage 2 — Strangulation:** Victim strangled with silk curtain cord while incapacitated
...
| 3   | **Kavya Sharma**   | 34  | Fiancée             | Engaged 6 months              | **KILLER** — Jealousy, inheritance     | Stayed overnight |
...
### Tier 3: Tertiary Suspects (10) — Appendix Only
...
| 17  | Suresh Patil     | Bartender (Lead)         | On duty              |
...
### Pre-Murder Setup — The Conspiracy

| Date     | Time        | Event                                                                               | Evidence           |
| -------- | ----------- | ----------------------------------------------------------------------------------- | ------------------ |
| Oct 2024 | —           | Kavya discovers Arjun's affair with Deepika                                         | —                  |
| Late Nov | —           | Kavya reconnects with ex-boyfriend Vikash Mehta                                     | Background check   |
| Nov 22   | —           | **RED HERRING:** Rohit purchases something from pharmaceutical supplier (₹2.5 Lakh) | Purchase records   |
| Dec 1    | —           | Kavya learns of will changes; Deepika's child gets inheritance                      | Legal notification |
| Dec 10   | —           | Kavya learns of Vikram's gift bottle from housekeeper                               | —                  |
| Dec 11   | —           | **Vikash purchases identical Macallan 25 (BTL-7711), adds Diazepam**                | Cash receipt, CCTV |
| Dec 11   | —           | Vikram orders original Macallan 25 as peace offering                                | Order receipt      |
| Dec 12   | 15:45       | Original bottle (BTL-7794) delivered to estate; Arjun in Mumbai                     | Delivery manifest  |
| Dec 12   | 19:32       | **RED HERRING:** Rohit arrives at estate "for documents"                            | Gate log           |
| Dec 12   | 19:32-21:15 | Rohit in study; **ORIGINAL BOTTLE (BTL-7794) STILL THERE — HE DOES NOT TOUCH IT**   | —                  |
| Dec 12   | 21:15       | Rohit departs estate                                                                | Gate log           |
| Dec 13   | 18:00       | Arjun returns from Mumbai with Kavya                                                | Gate log           |
| Dec 13   | 19:00       | Catering staff arrive; **Vikash brings drugged bottle (BTL-7711)**                  | Catering log       |
| Dec 13   | 19:30       | **Kavya swaps bottles during "event setup"** — signs staging checklist              | Staging checklist  |
| Dec 13   | 20:00       | Party begins; original bottle (BTL-7794) disposed by Vikash                         | —                  |
...
| 00:47 | Camera SC-1 goes offline (Anil's doing — embezzlement cover)               | Technical log   |
...
| 01:35 | Arjun drinks whiskey from SWAPPED BOTTLE (BTL-7711); sedative takes effect | —               |
| 01:45 | Deepika leaves study (had champagne, unaffected)                           | Camera SC-2     |
| 01:50 | Rohit enters study "to say goodbye"                                        | Camera SC-2     |
| 02:05 | Rohit leaves study; Arjun heavily sedated but alive                        | —               |
| 02:10 | Rohit departs estate (last GUEST to leave)                                 | Gate log        |
| 02:15 | **Vikash enters study via service kitchen path**                           | —               |
| 02:20 | **Vikash strangles incapacitated Arjun with curtain cord**                 | —               |
| 02:25 | Vikash removes ligature, discards in garden; stages scene                  | Fiber evidence  |
| 02:30 | Vikash exits with catering cleanup crew                                    | Catering log    |
...
| **Time of Death**          | 2:15-2:30 AM                                     | Based on liver temp, rigor onset         |
...
| Bottle liquid (EV-003) | 0.8 mg/mL        | **Confirms source — but which bottle?**  |
...
**Rohit's Total Loss:** ₹23,950 Crore (makes him a RED HERRING)

**Kavya's Problem:** If Arjun leaves her for Deepika, she gets NOTHING.

**Critical Clause:** Convicted beneficiary forfeits their share to remaining beneficiaries.

---

## RED HERRINGS (12 Total)
...
| 4   | Vikram's gift bottle            | He drugged it            | Genuine peace offering; Kavya swapped it                       |
...
| 10  | Missing curtain cord            | Planted by outsider      | Vikash used it, discarded in garden                            |
| 11  | **Rohit's Dec 12 visit**        | **He drugged bottle**    | **Original bottle (BTL-7794) still there; he didn't touch it** |
| 12  | **Rohit's pharma purchase**     | **He acquired sedative** | **UNEXPLAINED — permanent red herring**                        |
...
- **CLUE PLANTED:** Evidence inventory shows **Bottle ID: BTL-7711**
...
| 2 - Forensics | Autopsy, toxicology | Strangulation findings, **EV-003 Bottle ID: BTL-7711** |
...
- Rohit visited estate on Dec 12 (RED HERRING — bottle not swapped yet)
- Rohit's ₹2.5L pharmaceutical purchase (RED HERRING — NEVER EXPLAINED)
- **CRITICAL:** Delivery manifest shows **Bottle ID: BTL-7794** (DIFFERENT!)
- Catering staff log shows **Vikash Mehta** as bar assistant
- Kavya and Vikash were college sweethearts (2013-2015)

**New Evidence:**

| Detective     | Evidence Type       | Key Items                                                                |
| ------------- | ------------------- | ------------------------------------------------------------------------ |
| 1 - Timeline  | Pre-party access    | Rohit's Dec 12 visit, **Delivery manifest (BTL-7794)**, **Catering log** |
| 2 - Forensics | Fiber analysis      | Silk cord matches curtains; Rohit's pharma purchase (unexplained)        |
| 3 - Social    | Backgrounds         | Rohit-Deepika history, **Kavya-Vikash prior relationship**               |
| 4 - Objects   | Physical analysis   | Curtain cord missing, movement paths, service kitchen route              |
| 5 - Motive    | Financial deep-dive | Full 23-suspect motive breakdown                                         |

**Smart players can solve it here:** BTL-7711 (evidence) ≠ BTL-7794 (delivered) → Bottle was swapped!

### Phase 3: THE TWIST (15 min)

**REVELATION:** _Shared with all detectives_
...
- Evidence reconciliation report (BOTTLE ID MISMATCH)
- Secondary bottle purchase — CCTV shows Vikash Mehta (Dec 11)
- Cabinet access log — Kavya signed staging checklist (Dec 13, 19:30)
- Swap window identified: Dec 13, 19:00-20:00
...
| --- | ------------------------------- | --------------------------------------------- |
| 1   | Who strangled the victim?       | **Vikash Mehta**                              |
| 2   | Who drugged/swapped the bottle? | **Kavya Sharma + Vikash Mehta**               |
| 3   | Why couldn't victim fight back? | Sedative incapacitated him                    |
| 4   | When was bottle swapped?        | **Dec 13 evening (19:00-20:00)**              |
| 5   | Key evidence proving killers?   | **Bottle ID mismatch (BTL-7794 vs BTL-7711)** |
...
| 3 - The Twist            | 15 min     | Reveal bottle SWAP mechanism         |
...
| EV-002 | Champagne glass          | Study cabinet | Deepika's lipstick; innocently moved                               |
| EV-003 | Macallan 25 bottle       | Study bar     | **Bottle ID: BTL-7711** — Contains Diazepam (0.8 mg/mL) — THE SWAP |
| EV-004 | Burner phone             | Study drawer  | Contacts "D" and "R" (Arjun's whistleblower investigation)         |
| EV-005 | Pearl earring            | Under desk    | Deepika's (proves she was there)                                   |
| EV-006 | Torn note                | Wastebasket   | Partial text about funds                                           |
| EV-007 | Silk cord                | **Missing**   | One of pair from curtains — murder weapon                          |
...
When Kavya learned that Vikram Saxena was sending Arjun a gift bottle, she saw her opportunity. If they could swap the bottle with a drugged duplicate, suspicion would fall on Vikram — the man who had publicly argued with Arjun about the merger.

On December 11th, Vikash purchased an identical Macallan 25 (Bottle ID: BTL-7711) from Mumbai Wine & Spirits, paying cash. He added pharmaceutical-grade Diazepam — enough to incapacitate a man.

On December 12th, the original bottle (BTL-7794) arrived at the estate. That evening, Rohit visited "to collect documents" — a perfect red herring. But the original bottle was still there. Rohit's pharmaceutical purchase from November remains unexplained — he never used it.

On December 13th, Vikash arrived with the catering crew, carrying the drugged bottle in his bag. During "event setup" at 7:30 PM, Kavya accessed the study and swapped the bottles, signing the staging checklist. The original bottle was disposed of by Vikash.

At the party, Kavya played the perfect fiancée. She encouraged Arjun to open "Vikram's special gift" for a toast. Around 1:30 AM, Arjun met Deepika in the study and drank from the drugged bottle. He became increasingly drowsy.

Rohit visited the study at 1:50 AM to "say goodbye." He found his father slurring and confused, but left without incident at 2:05 AM.

At 2:15 AM, after the last guest departed, Vikash entered the study via the service kitchen path — a route not covered by cameras. Arjun was slumped in his chair, barely conscious. Vikash took the silk cord from the curtains and strangled him. There was no struggle — the sedative had done its work.

Vikash discarded the cord in the garden and exited with the catering cleanup crew at 2:30 AM.

The irony: The evidence points overwhelmingly at Rohit. His December 12 visit, his pharmaceutical purchase, his financial motive — it all fits. But it's wrong. The bottle ID mismatch is the only clue that reveals the truth: the bottle was swapped, not tampered with. And only Kavya and Vikash had both the means and the opportunity to execute the swap.
...
| File                   | Contents                              | For           |
| ---------------------- | ------------------------------------- | ------------- |
| 01_CASE_BRIEF.md       | Introduction, 23 suspects, floor plan | All players   |
...
| 04_PHASE_3_TWIST.md    | The revelation (bottle SWAP)          | All players   |
...
- Phase 1: Let them discover basics, plant BTL-7711
- Phase 2: They'll build the Rohit theory — that's expected and desired
- Phase 3: The bottle ID mismatch should cause "wait, what?"
- Phase 4: Light time pressure creates urgency

### If Players Are Stuck

**Phase 1-2:** Don't help. Let them build the wrong theory (Rohit).

**Phase 3:** Ask leading questions:

- "Compare the bottle IDs from Phase 1 and Phase 2."
- "Who else arrived at the estate on December 13?"
- "What's the connection between Kavya and the catering staff?"

**Phase 4:** Last resort hints:

- "The bottle was SWAPPED, not tampered with. Who could do that?"
- "Look at the catering staff log."
- "When did Kavya have access to the study cabinet?"

### Common Wrong Theories

1. **Rohit** (pharma purchase, Dec 12 visit, motive) — **THE INTENDED MISDIRECTION** — Let them build this theory; it falls apart with the bottle ID mismatch
2. **Deepika** (was in study, earring found) — Good misdirection; she had champagne
3. **Anil** (camera, service kitchen) — Plausible but wrong motive
4. **Vikram** (sent the bottle) — The frame; alibi is solid
5. **Dr. Menon** (sedative access) — Red herring; left early

The correct answer (Kavya + Vikash) requires players to:

1. Notice the bottle ID mismatch
